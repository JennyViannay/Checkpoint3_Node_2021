...
describe('🎧 ALBUMS ROUTES', () => {
  ...
  it(`should update the last created album title 🧪 /api/albums/`, async () => {
    await supertest(app)
    ...
    expect(res.body).toHaveProperty('title', 'Flip');
  });

  it(`should delete the last album created 🧪 /api/albums/`, async () => {
    await supertest(app)
